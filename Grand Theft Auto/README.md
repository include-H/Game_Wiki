# 《侠盗猎车手》3D时代 / HD时代 Wiki 目录

> 说明：本目录用于集中整理《侠盗猎车手》（Grand Theft Auto）系列在 3D 时代与 HD 时代的相关 Wiki 条目，不包含 `Grand Theft Auto`、`Grand Theft Auto 2` 与《London》这类早期 2D 时代作品。本文主要依据 Rockstar Games / Rockstar Store 官方页面、Wikipedia、GTA Wiki 与公开资料整理而成，默认包含剧情概述、版本关系与一定剧透说明。
...
因此，理解《侠盗猎车手》最好的方法，往往不是把它当成一串数字编号，而是把它看成两轮“重塑现代都市犯罪游戏”的过程：第一轮是《GTA III》《Vice City》《San Andreas》把框架立住，第二轮则是《GTA IV》与《GTA V》把这个框架推向更高预算、更强写实感和更大规模的现代版本。
...
- [《Grand Theft Auto III》Wiki](./GRAND_THEFT_AUTO_III_WIKI.md)
- [《Grand Theft Auto: Vice City》Wiki](./GRAND_THEFT_AUTO_VICE_CITY_WIKI.md)
- [《Grand Theft Auto: San Andreas》Wiki](./GRAND_THEFT_AUTO_SAN_ANDREAS_WIKI.md)

这是整个系列最重要的第一次定型期。《GTA III》负责把系列正式推入现代 3D 开放世界；《Vice City》把年代氛围、角色魅力和流行文化讽刺彻底做成品牌记忆；《San Andreas》则把地图规模、系统复杂度和“什么都能做一点”的野心推到 3D 时代顶点。
...
这一阶段的作品大多围绕既有城市继续补时间线、补人物关系或做掌机适配。其中最需要单独点明的，就是 PSP 上的《Liberty City Stories》《Vice City Stories》两作。它们不是边角料式的小外传，而是 3D 时代非常重要的前传补完内容；《Advance》则是更偏掌机过渡性质的一支。

### 2.3 HD 时代 Liberty City 重构期
...
这条线基本就能看出《侠盗猎车手》如何从“定义 3D 开放世界犯罪游戏”，一路走到“定义现代高预算都市开放世界”。
...
《侠盗猎车手》这个系列最容易混淆的地方，主要集中在以下几处：

- 3D 时代与 HD 时代是玩家和官方长期使用的分段理解方式，但两者不是简单的“同一时间线画质升级”，而是包含明显连续设定重置的两套阶段。
...
也因此，写这个系列时最好始终把“所属时代、具体版本名、是否为资料片 / 整合版 / 重制版”一并写清。
...
《侠盗猎车手》在 3D 时代定义了现代都市犯罪开放世界，在 HD 时代又把这套东西重做得更密、更大、更像一面会动的时代讽刺镜子。
